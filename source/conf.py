...
copyright = u'2016-2017, Feng Lee <feng@emqtt.io>'
...
latex_documents = [
  ('index', 'ErlangMQTTBroker.tex', u'EMQ 2.0 Documentation',
   u'Feng Lee <feng@emqtt.io>', 'manual'),
]
...
texinfo_documents = [
  ('index', 'ErlangMQTTBroker', u'Erlang MQTT Broker Documentation',
   u'Feng Lee <feng@emqtt.io>', 'ErlangMQTTBroker', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2016-2017, Feng Lee <feng@emqtt.io>'
